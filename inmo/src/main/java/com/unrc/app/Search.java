...
public class Search{
	...
	public String toString(){
		...
		//	if(nameow != null){
		//	list= "/n"+list+" Precio: "+price+ " id: "+ id +" Tipo: "+type+" Categoria: "+category +" Direccion: "+street+" Barrio: "+neigh+" Localidad: "+namelocality+ " Descripcion: "+desc+"Duenio: "+ nameow+"\n";
			//}
			///else{
			//	list= "/n"+list+" Precio: "+price+ " id: "+ id +" Tipo: "+type+" Categoria: "+category +" Direccion: "+street+" Barrio: "+neigh+" Localidad: "+namelocality+ " Descripcion: "+desc+"\n";
		//	}
